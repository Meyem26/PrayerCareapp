/**
 * Dashboard paste variant: send-group-invite
 *
 * Deploy as Edge Function named exactly: send-group-invite
 * Secrets (usually auto + Resend): RESEND_API_KEY, BETA_FROM_EMAIL or FROM_EMAIL,
 * APP_URL (optional, defaults from SITE_URL)
 */
